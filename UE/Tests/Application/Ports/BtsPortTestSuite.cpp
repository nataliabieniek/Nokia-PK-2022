...
common::BinaryMessage msg;
EXPECT_CALL(transportMock, sendMessage(_)).WillOnce([&msg](auto param){msg = std::move(param); return true;});
objectUnderTest.sendSms(PHONE_NUMBER_RECIPIENT, "Wiadomosc testowa");
common::IncomingMessage reader(msg);
...
ASSERT_NO_THROW(EXPECT_EQ("Wiadomosc testowa", reader.readRemainingText()));
}
...
common::BinaryMessage msg;
EXPECT_CALL(transportMock, sendMessage(_)).WillOnce([&msg](auto param){msg = std::move(param); return true;});
objectUnderTest.sendCallAccept(PHONE_NUMBER_RECIPIENT);
common::IncomingMessage reader(msg);
...
common::BinaryMessage msg;
EXPECT_CALL(transportMock, sendMessage(_)).WillOnce([&msg](auto param){msg = std::move(param); return true;});
objectUnderTest.sendCallDrop(PHONE_NUMBER_RECIPIENT);
common::IncomingMessage reader(msg);
...
common::BinaryMessage msg;
EXPECT_CALL(transportMock, sendMessage(_)).WillOnce([&msg](auto param){msg = std::move(param); return true;});
objectUnderTest.sendCallTalk(PHONE_NUMBER_RECIPIENT, "Wiadomosc testowa");
common::IncomingMessage reader(msg);
